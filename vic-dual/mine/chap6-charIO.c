...
/* Parece 99% com o código hello_world daqui mas fui eu que escrevi. 
Pelo menos hoje (23/10) entendo tudo que está acontecendo */
...
void scrollup() {
  /* o terceiro ser ou nao 1024 a principio n parece 
  diferenciar em algo sendo 32 ou 1024, mas suspeito que seja
  pq os valores no momento presentes na memoria n sao muitos,
  e o -1 é pra nao subir pra cima um valor que nao esteja na area
  de video da memoria
  */
...
int putchar( int c){
  ...
  cellram[cursor_x][31 - cursor_y] = c;
  cursor_x++;
...
void main() {
  ...
  printf("%p\n", &cellram[0][0]);
  printf("%p\n", &cellram[0][1]);
  printf("%d", sizeof(cellram));
  
  //cellram[0][1] = 'a'; cellram[0][0] = 'b';
